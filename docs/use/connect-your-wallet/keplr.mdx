...
Connect your Keplr wallet with Flamez.
...
3. Make sure you are on the `Butane Testnet` network from the dropdown. Testnet networks will likely be towards the bottom
of the list.
...
Twitter, `0.5 tBBC` and signed in Keplr Wallet. If you need to obtain `BBC` token, check out
