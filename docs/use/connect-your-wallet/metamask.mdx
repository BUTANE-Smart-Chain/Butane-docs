...
Connect your Metamask wallet with Butane. 
...
:::note
If you are planning on developing on Butane locally and you haven’t already set up your own local node, refer to [the quickstart tutorial](./../../protocol/evmos-cli/single-node), or follow the instructions in the [GitHub repository](https://github.com/evmos/evmos/).
:::

:::tip
If you need to add Butane Testnet and Mainnet to Metamask wallet, head over [here](https://chainlist.org/?testnets=true&search=evmos) to add configurations.
:::
